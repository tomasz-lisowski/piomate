...
cmp ./example/apa102_1.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/hub75_0.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/hub75_1.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/i2c_0.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/onewire_library.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/quadrature_encoder_substep.pio.hex ./example/tmp.hex;
...
./zig-out/bin/piomate disassemble \
    ...
    2>/dev/null > ./example/tmp.pio;
pioasm -o hex ./example/tmp.pio ./example/tmp.hex;
cmp ./example/quadrature_encoder.pio.hex ./example/tmp.hex;
